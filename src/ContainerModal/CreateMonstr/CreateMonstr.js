...
export const CreateMonstr = ({ setShowCreateMonstr }) => {
  ...
  const createMonstr = () => {
    if (
      ...
      inputXp.current.value !== "" &&
      Number(inputXp.current.value) &&
      inputStrong.current.value !== "" &&
      Number(inputStrong.current.value) &&
      inputArmor.current.value !== "" &&
      Number(inputArmor.current.value)
    ) {
      dispatch({
        type: ContainerActivType.create_monstr,
        payload: {
  ...
  return (
    <div className="container_create_monstr">
      ...
      <br />
      <button
        className="button_create_monstr"
        onClick={() => {
