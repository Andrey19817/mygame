...
export const Admin = () => {
  ...
  return (
    <div className={cls.wrapper_admin}>
      {showCreateMonstr && (
        <CreateMonstr setShowCreateMonstr={setShowCreateMonstr} />
      )}
      <div className={cls.wrapper_monstr}>
        {" "}
        {noFilter &&
          monstrArea
      ...
      <button
        className={cls.add_monstr}
        onClick={() => {
          setShowCreateMonstr(true);
      ...
      <button
        className={cls.button_reestablish}
        onClick={() => {
          isAudioPlay && audioClick.play();
