    ...
    return (
        ...
        <div className="container_hero_window">
            <div className="hero_window" >
                <img className="hero_window_avatar" style={{width:'90px', height:'90px',boxShadow: '0 0 10px 2px black',border: '2px solid',
    borderImage: 'url(https://i.gifer.com/RRr2.gif)  1 '}} src={avatar.src} onClick={()=>{
