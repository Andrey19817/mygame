...
const Main = () => {
    ...
    return (
        ...
        <MainContext.Provider value={{persArea, showCheat, setShowCheat, myXp, setMyXp, pers, treatment, setTreatment, death, setDeath, setTreatment_play, treatment_play, level, monstrArea, setLevel, setMonstrArea, monstrXp, setMonstrXp, damageMy_Display, setDamageMy_Display, damageMy, setDamageMy, damageMonstr_Display, setDamageMonstr_Display, damageMonstr, setDamageMonstr, change, setChange, isBtn, setisBtn, isBtn_20, seisBtn_20, displayDice, setDisplayDice, displayDice_6, setDisplayDice_6,isAudioPlay, setIsAudioPlay,audioFon }}>
            <App />,
