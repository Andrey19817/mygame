...
const {isBtn, setisBtn,isBtn_20,displayDice_6,displayDice,isAudioPlay} = useContext(MainContext)
  ...
  isAudioPlay && audioRef.current.play()
    ...
    return (
        <div className="container_button">
            ...
            <div className={`dice_6 ${dice_6_activ ? 'dice_6_play' : ''}`} onClick={atack6}>{displayDice_6}</div>
            </div>}
            {isBtn_20 && <div className="containr_button_atack20 ">
            <div className={`dice_20 ${dice_20_activ ? 'dice_20_play' : ''}`} onClick={atack20}>
