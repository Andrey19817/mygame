...
export const ContainerCharacteristics = ({ showAvatar }) => {
  const {
    treatment,
    setTreatment,
    death,
  ...
  return (
    <div className="container_characteristics">
      ...
      <div className="container_monstr_display">
        ...
        >
          {damageMy_Display ? (
            <div className="damageMy">{-damageMy}</div>
          ) : null}
          {damageMy_Display ? <div className="monsterTakesDamage"></div> : null}
        </div>
        {damageMonstr_Display ? (
          <div className="damageMonstr">{-damageMonstr}</div>
        ) : null}
      </div>
      <div className="container_monstr_characteristics">
        <img
          ...
          style={{
            ...
            border: "1px solid",
            borderImage:
              "url(https://acegif.com/wp-content/gifs/fire-13.gif)  27 ",
          }}
          alt=""
        />
